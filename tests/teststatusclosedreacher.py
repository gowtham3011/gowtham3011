...
payload_time['content']["title"] = 'closed by researcher'
payload_time['content']['body'] = "closed by researcher"
payload_time['content']['platform_specific']['android']['deep_link'] = "iiflmarketsapp://gems?GEMSOLOID=84eba3adbf7240798c621ad41ba5e3c6"
payload_time['content']['platform_specific']['android']['wzrk_acts']= [{'l': 'Trade Now', 'dl': 'iiflmarketsapp://Buypage?SM=EURINR&SC=1762&EX=N&EXT=U', 'id': '1'}]
payload_time['content']['platform_specific']['android']['Cat']= "SELL"
